...
const uint8_t THERMISTOR_PINS[] = {A0};  // Analog pins for thermistors

// Timing configuration
const unsigned long SAMPLE_INTERVAL = 100;  // Measurement interval in milliseconds
...
void setup() {
  ...
  SoftADC_begin(THERMISTOR_PINS, NUM_THERMISTORS);
